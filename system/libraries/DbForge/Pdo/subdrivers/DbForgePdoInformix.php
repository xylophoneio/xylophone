...
/**
 * PDO Informix Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Pdo/subdrivers
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgePdoInformix extends \Xylophone\libraries\DbForge\Pdo\DbForgePdo
{
    ...
    protected function attrUnique(&$attributes, &$field)
    {
        if (!empty($attributes['UNIQUE']) && $attributes['UNIQUE'] === true) {
            $field['unique'] = ' UNIQUE CONSTRAINT '.$this->db->escapeIdentifiers($field['name']);
        }
    }
