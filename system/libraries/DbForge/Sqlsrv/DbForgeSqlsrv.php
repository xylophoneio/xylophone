 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Sqlsrv;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * SQL SRV Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Sqlsrv
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeSqlte3 extends \Xylophone\libraries\DbForge\DbForge
{
