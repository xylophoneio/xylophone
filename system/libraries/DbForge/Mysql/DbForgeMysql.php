 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Mysql;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * MySQL Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Mysql
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeMysql extends \Xylophone\libraries\DbForge\DbForge
{
