 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Cubrid;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * CUBRID Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Cubrid
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeCubrid extends \Xylophone\libraries\DbForge\DbForge
{
