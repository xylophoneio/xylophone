 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Sqlite;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * SQLite Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Sqlite
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeSqlite extends \Xylophone\libraries\DbForge\DbForge
{
