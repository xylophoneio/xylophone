 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Mssql;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * MS SQL Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Mssql
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeMssql extends \Xylophone\libraries\DbForge\DbForge
{
