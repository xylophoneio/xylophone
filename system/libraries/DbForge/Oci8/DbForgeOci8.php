 ...
 * @filesource
 */
namespace Xylophone\libraries\DbForge\Oci8;

defined('BASEPATH') OR exit('No direct script access allowed');

/**
 * Oracle Database Forge Class
 *
 * @package     Xylophone
 * @subpackage  libraries/DbForge/Oci8
 * @link        http://xylophone.io/user_guide/database/
 */
class DbForgeOci8 extends \Xylophone\libraries\DbForge\DbForge
{
